...
void glh::keyboardCallback(GLFWwindow* window, int key, int scancode,
                             int action, int mods){
...
void glh::init(){
    ...
    glfwSetKeyCallback(window, NULL); // Set GLFW call back function
...
glh::glh(int w=800, int h=480, string name=string("OpenGL Window"))
{
	width = w;
	height = h;
	windowName = name;
